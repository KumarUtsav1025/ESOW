...
import 'package:esos/Screens/Login/cubit/loginCubit.dart';
...
class Login extends StatelessWidget {
  ...
  Widget _buildSuccess(double height, double width, BuildContext context) {
    return SafeArea(
          child: Stack(
            children: [
              Center(child: Image.asset(S.login),),
              Center(
                child: Container(
                  height: height*0.48,
                  ...
                  child: FrostedGlassBox(
                    ...
                    theChild: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          const SizedBox(height: D.horizontalPadding,),
                          Padding(
                              ...
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(text: 'Sign up',
                                      ...
                                      style: const TextStyle(fontWeight: FontWeight.bold, color: C.gradientColor3)),
                                ],
                              ),
                            ),
                          ),
